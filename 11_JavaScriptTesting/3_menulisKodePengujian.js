...
test('deskripsi darit testcase kamu', () => {
...
* toBe(4) disebut dengan matcher, berisi nilai yang diharapkan dari sebuah perintah yang dilakukan sebelumnya. Dalam jest sendiri
* terdapat berbagai matchers yang dapat digunakan, misalkan:
...
* ada framework jest, kita juga dapat menuliskan sebuah test secara grouping berdasarkan karakteristik ataupun grup yang sama
* menggunakan segmen describe , misalkan sebagai berikut:
