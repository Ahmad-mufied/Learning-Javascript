...
* Hal yang seringkali membingungkan ketika bekerja dengan program synchronous dan asynchronous adalah bagaimana
...
* Seperti yang sudah kita ketahui, fungsi setTimeout() tidak akan menghentikan JavaScript untuk mengeksekusi kode yang ada selanjutnya.
* Jadi, fungsi orderCoffee() akan selalu mengembalikan nilai null, karena kode return coffee akan dieksekusi terlebih dulu dibandingkan
* dengan coffee = "Kopi sudah jadi!";. Kode asynchronous perlu disusun dengan cara yang berbeda dari synchronous. Cara paling dasar
* adalah dengan callback function.
...
* -- (Asynchronous) Kita menunggu di meja setelah memesan kopi. Selanjutnya kopi akan diantarkan oleh pelayan. Sehingga, kita tidak perlu
*    menunggu di kasir dan dapat melakukan pekerjaan lain.

* Nah, pada JavaScript, pelayan ini berperan layaknya callback function. Ia diperintahkan pada sebuah fungsi asynchronous kemudian akan
...
* Bagaimana cara menerapkannya dalam kode? Pertama, kita tambahkan parameter dengan nama callback pada fungsi asynchronous.
 ...
 const orderCoffee = callback => {
     let coffee = null;
     console.log("Sedasng membuat kopi, silahkan tunggu...");
     setTimeout(() => {
         coffee = "Kopi sudah jadi";
     }, 3000);
     return coffee;
...
* Keseluruhan fungsi akan tampak seperti ini:
