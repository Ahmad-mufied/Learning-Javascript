...
/* 
* Note:
* Meskipun kita bisa menetapkan dan mendapatkan data pada map seperrti ini:
...
* Namun, kode di atas bukanlah cara yang sesuai untuk mengoperasikan Map. Ketika kita menetapkan
* nilai map seperti di atas, data akan disimpan sebagai generic object. Ini akan mengakibatkan data tidak tersimpan
* dalam Map query dan tidak bisa menggunakan fitur dari Map seperti .has atau .delete.
*/
